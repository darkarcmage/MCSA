			...
			<p>Click on the questions to reveal the answer</p>	
				...
				<h4 class="faqQ" id="q001">  How can I become a member of the MCSA Magaliesberg section?</h4>
					...
					Many outdoor shops and climbing gyms offer discounts to MCSA members. You have to be able to show your MCSA membership card.
					  ...
					  <p> Some MCSA sections owns property and thus the risks, rewards and costs are higher. Each section of the MCSA are managed  by a separate  committee which try to adhere to the unique requirements of that section's members.</p>
					  </div>

					  <h4  class="faqQ" id="q005">May I take friends, who are not MCSA members, to MCSA property?</h4>
					  <div class="faqA" id="a005">
					  <p> You may only take one friend with you. If you take more than one friend per MCSA member you have to apply for a permit by the section issueing permits for that property.
					  <br> Or alternatively you may make your trip an official MCSA meet and take a lot of non-memebers, however then the standard guest fee have to be paid to the club after the meet.</p>
					  </div>
					  ...
					  <h4  class="faqQ" id="q008">May I take guests with to the club property? </h4>
					  <div class="faqA" id="a008">
					  ...
					  <h4  class="faqQ" id="q009">When do we pay guest fees?</h4>
					...
					<h4  class="faqQ" id="q010">How do I pay the membership fees? What is the club bank number?</h4>
					  ...
					  <br> For membership fees, new members applications, guest fees and permit fees (only permit fees to the Grootkloof property and Wilgepoort property) and other payments please pay to:
					  <br> Nedbank Current Account
					  <br> Account number 1602096171
					  <br> Payment Reference: Members please use your club number, words "memberfee" and the year ex <b> MAG000_MemberFee_2017 </b>
					  <br> for permit payments your surname,  words "permit" and the property name ex <b> surname_Permit_Grootkloof  </b>.
					    </p>
					   <p><br> For <b> Dome pool permit </b> fees please pay to:
					  <br> Nedbank  Savings Account
