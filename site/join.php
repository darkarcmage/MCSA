			...
			<div class="about-bottom">
				<div class="col-md-8 about-grid">
					...
					<form method="post" action="joinEngine.php" id="formtocomplete"  name="JoinForm" onsubmit="return validateJoin(this)">
						...
						<br/><br/>
						<div class="visitors" style="width: 100%; max-width: 1000px;"> 
						<label style="width: 100%" for="CurrentMembership">Name any MCSA Section or other mountain club of which you are a member at present if any:<span style="color:red;">* </span></label>
						...
						<label style="width: 100%" for="PreviousMembership">Name any section of the MCSA or the mountain club of which you were previously a member, and the duration  of  your membership:<span style="color:red;">* </span></label>
